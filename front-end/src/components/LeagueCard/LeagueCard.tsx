...
const LeagueCard = ({ league }: LeagueCardProps) => {
  ...
  const commissionerLabel =
    userId && league.commissionerId === userId
      ? "You"
      : league.commissionerDisplayName;
  ...
  return (
    <article className="league-card">
      <div className="league-card__header">
        <div>
          ...
          <p className="league-card__commissioner">
            Commissioner: {commissionerLabel}
          </p>
        </div>
        <span
      ...
      <div className="league-card__actions">
        <span className="league-card__sport">{league.sport}</span>
        <button
